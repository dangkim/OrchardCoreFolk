...
public class CardsPartViewModel : IValidatableObject
{
    ...
    [BindNever]
    public CardsPart CardsPart { get; set; }
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        var localizer = validationContext.GetService<IStringLocalizer<CardsPartViewModel>>();
