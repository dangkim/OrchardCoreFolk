...
public class StartTopBetSucceedPartViewModel : IValidatableObject
{
    ...
    [BindNever]
    public StartStopBetSucceedPart StartTopBetSucceedPart { get; set; }
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        var localizer = validationContext.GetService<IStringLocalizer<StartTopBetSucceedPartViewModel>>();
