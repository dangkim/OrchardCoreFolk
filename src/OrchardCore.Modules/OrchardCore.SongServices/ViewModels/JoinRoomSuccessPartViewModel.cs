...
public class JoinRoomSuccessPartViewModel : IValidatableObject
{
    ...
    [BindNever]
    public JoinRoomSuccessPart JoinRoomSuccessPart { get; set; }
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        var localizer = validationContext.GetService<IStringLocalizer<JoinRoomSuccessPartViewModel>>();
