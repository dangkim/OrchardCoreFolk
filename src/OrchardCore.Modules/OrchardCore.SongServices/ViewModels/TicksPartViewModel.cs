...
public class TicksPartViewModel : IValidatableObject
{
    ...
    [BindNever]
    public TicksPart TicksPart { get; set; }
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        var localizer = validationContext.GetService<IStringLocalizer<TicksPartViewModel>>();
