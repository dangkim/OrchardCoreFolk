...
public class DealerPartViewModel : IValidatableObject
{
    ...
    [BindNever]
    public DealerPart DealerPart { get; set; }
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        var localizer = validationContext.GetService<IStringLocalizer<DealerPartViewModel>>();
