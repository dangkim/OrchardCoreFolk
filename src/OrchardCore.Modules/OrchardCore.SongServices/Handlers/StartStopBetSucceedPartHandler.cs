...
// ContentHandlerBase.
public class StartStopBetSucceedPartHandler : ContentPartHandler<StartStopBetSucceedPart>
{
    // Did you notice that when you list StartTopBetSucceed content items on the dashboard the title of the list item also says the
    // StartTopBetSucceed's name? This is because what's displayed there is the content item's DisplayText (you can think of it as a
    ...
    public override Task UpdatedAsync(UpdateContentContext context, StartStopBetSucceedPart instance)
    {
        context.ContentItem.DisplayText = instance.Table;
