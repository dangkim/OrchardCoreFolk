...
// ContentHandlerBase.
public class TradePartHandler : ContentPartHandler<TradeFilteringPart>
{
    ...
    public override Task UpdatedAsync(UpdateContentContext context, TradeFilteringPart instance)
    {
        context.ContentItem.DisplayText = instance.TradeType + ";" + instance.TradeVNDAmount + ";" + instance.TradeBTCAmount + ";" + instance.TradeETHAmount + ";" + instance.TradeUSDT20Amount + ";" + instance.CurrencyOfTrade + ";" + instance.TradeBTCAmount + ";" + instance.OfferId + ";" + instance.TradeStatus + ";" + instance.Seller + ";" + instance.Buyer + ";" + instance.DateTime.ToString();

        return Task.CompletedTask;
    }
    public override Task PublishedAsync(PublishContentContext context, TradeFilteringPart instance)
    {
        context.ContentItem.DisplayText = instance.TradeType + ";" + instance.TradeVNDAmount + ";" + instance.TradeBTCAmount + ";" + instance.TradeETHAmount + ";" + instance.TradeUSDT20Amount + ";" + instance.CurrencyOfTrade + ";" + instance.TradeBTCAmount + ";" + instance.OfferId + ";" + instance.TradeStatus + ";" + instance.Seller + ";" + instance.Buyer + ";" + instance.DateTime.ToString();
