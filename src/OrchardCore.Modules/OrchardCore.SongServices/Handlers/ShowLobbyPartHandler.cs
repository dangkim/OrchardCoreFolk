...
// ContentHandlerBase.
public class ShowLobbyPartHandler : ContentPartHandler<ShowLobbyPart>
{
    // Did you notice that when you list ShowLobby content items on the dashboard the title of the list item also says the
    // ShowLobby's name? This is because what's displayed there is the content item's DisplayText (you can think of it as a
    ...
    public override Task UpdatedAsync(UpdateContentContext context, ShowLobbyPart instance)
    {
        context.ContentItem.DisplayText = instance.TableId + ";" + instance.GameName + ";" + instance.DealerGameName;
