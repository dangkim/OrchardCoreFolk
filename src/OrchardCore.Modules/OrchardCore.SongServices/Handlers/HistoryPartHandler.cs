...
// ContentHandlerBase.
public class HistoryPartHandler : ContentPartHandler<HistoryPart>
{
    // Did you notice that when you list History content items on the dashboard the title of the list item also says the
    // History's name? This is because what's displayed there is the content item's DisplayText (you can think of it as a
    ...
    public override Task UpdatedAsync(UpdateContentContext context, HistoryPart instance)
    {
        context.ContentItem.DisplayText = instance.Kind;
