...
// ContentHandlerBase.
public class OfferPartHandler : ContentPartHandler<OfferFilteringPart>
{
    ...
    public override Task UpdatedAsync(UpdateContentContext context, OfferFilteringPart instance)
    {
        context.ContentItem.DisplayText = instance.OfferType + ";" + instance.PaymentMethod + ";" + instance.OfferStatus + ";" + instance.Wallet + ";" + instance.PreferredCurrency + ";" + instance.Percentage.ToString() + ";" + instance.MinAmount.ToString() + ";" + instance.MaxAmount.ToString();
