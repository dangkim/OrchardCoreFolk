...
// ContentHandlerBase.
public class PoolPartHandler : ContentPartHandler<PoolPart>
{
    // Did you notice that when you list Pool content items on the dashboard the title of the list item also says the
    // Pool's name? This is because what's displayed there is the content item's DisplayText (you can think of it as a
    ...
    public override Task UpdatedAsync(UpdateContentContext context, PoolPart instance)
    {
