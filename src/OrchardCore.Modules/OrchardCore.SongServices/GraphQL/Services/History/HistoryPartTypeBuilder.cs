...
public class HistoryPartTypeBuilder : IContentTypeBuilder
{
    ...
    public const string StatusFilter = "gamestatus";
    public const string KindFilter = "kind";
    public const string ResultFilter = "result";
        ...
        ContentItemType contentItemType)
    {
        ...
        if (contentItemType.Fields.All(field => field.Name != "History")) return;
