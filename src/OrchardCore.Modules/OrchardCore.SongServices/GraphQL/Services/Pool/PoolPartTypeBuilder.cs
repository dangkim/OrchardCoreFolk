...
public class PoolPartTypeBuilder : IContentTypeBuilder
{
    // It's a good practice to make the argument name a const because you will reuse it in the IGraphQLFilter.
    public const string AmountFilter = "amount";
    public const string CatFilter = "cat";
        ...
        ContentItemType contentItemType)
    {
        ...
        if (contentItemType.Fields.All(field => field.Name != "Pool")) return;
