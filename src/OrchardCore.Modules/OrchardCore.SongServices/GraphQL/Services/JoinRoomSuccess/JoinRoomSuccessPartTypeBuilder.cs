...
public class JoinRoomSuccessPartTypeBuilder : IContentTypeBuilder
{
    ...
    public const string SeatFilter = "seat";
        ...
        ContentItemType contentItemType)
    {
        ...
        if (contentItemType.Fields.All(field => field.Name != "JoinRoomSuccess")) return;
