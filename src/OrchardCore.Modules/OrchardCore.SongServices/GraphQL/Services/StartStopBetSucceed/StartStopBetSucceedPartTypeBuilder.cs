...
public class StartStopBetSucceedPartTypeBuilder : IContentTypeBuilder
{
    // It's a good practice to make the argument name a const because you will reuse it in the IGraphQLFilter.
    public const string PowerupFilter = "powerup";
    public const string KindFilter = "kind";
    public const string ContentFilter = "betcontent";
    public const string RoundFilter = "round";
    public const string RoundIdFilter = "roundId";
    public const string ShoeFilter = "shoe";
    public const string StatusFilter = "betstatus";
        ...
        ContentItemType contentItemType)
    {
        ...
        if (contentItemType.Fields.All(field => field.Name != "StartStopBetSucceed")) return;
