...
namespace OrchardCore.SimService.SimApi
{
    ...
    public class OrderWareHouseFiveProfileController : Controller
    {
        ...
        #region Check order
        /// <summary>
        /// Check order of Ware House Five (Get SMS)
        /// </summary>
        /// <remarks>
        /// 
        /// </remarks> 
        [HttpGet]
        [ActionName("checkOrderWareHouseFive")]
        [ProducesResponseType(typeof(CheckOrderWareHouseFiveDto), (int)HttpStatusCode.OK)]
        ...
        [ReDocCodeSample("php", "$token = 'Your token';" +
            "\n$ch = curl_init();" +
            "\n$id = 1;" +
            "\ncurl_setopt($ch, CURLOPT_URL, 'https://openapi.simforrent.com/api/content/checkOrderWareHouseFive/'. $id);" +
        ...
        [ReDocCodeSample("python", "import requests" +
            ...
            "\n}" +
            "\nresponse = requests.get('https://openapi.simforrent.com/api/content/checkOrderWareHouseFive/' + id, headers=headers)")]
        [ReDocCodeSample("c#", "var client = new RestClient(\"https://openapi.simforrent.com/api/content/checkOrderWareHouseFive\");" +
            "\nvar request = new RestRequest();" +
            "\nrequest.AddHeader(\"Authorization\", \"Bearer \" + token);" +
            "\nrequest.AddHeader(\"Accept\", \"application/json\");" +
            "\nvar response = await client.ExecuteGetAsync(request);")]
        public async Task<ActionResult<CheckOrderWareHouseFiveDto>> CheckOrderWareHouseFiveAsync(string id, int inventory = (int)InventoryEnum.VSim)
        {
            ...
            var resObject = await ApiCommon.CheckOrderWareHouseFiveAsync(vSimToken, id, inventory);
            ...
            resObject.Product = resObject.Product;
